...
/*
Program tworzy liczbe watkow rowno liczbie przekazanych do programu argumentow. Kazdy watek po utworzeniu czeka
zadany przez argument czas, a nastepnie sie konczy. 
Program przechowuje w tablicy informacje o wszyskich stworzonych watkach - ich tid i ich stany.
Gdy watek konczy swoje dzialanie - stan TS_TERMINATED informuje o tym przez odpowiednia zmienna warunkowa,
na ktorej czeka glowny watek 

Uzupelnij oznaczone framenty kody zwiazane z operacjami na muteksie i zmiennej warunkowej.
*/
...
static int numLive = 0;         /* Calkowita liczba watkow wciaz zywych lub zakonczonych ale jeszcze nie joined */
